# 密歇根大学《给所有人的Django课程（简介、开发Web APP、特征和库、JavaScript和JSON）｜Django for Everybody》中英字幕 p25 25_05_01_利兹·方：SQL标准的创建者.zh_en -BV1Kt421V7EE_p25-
...
🎼是。And there were products that are coming。Growing from wild。 And then we realized that， hey。
...
呃。Technology that are ready to be standardized where people say。
 ...
 what I call database management system， is too varied and so you want to have some sort of a stand so that your application can work on。
...
Different platform。We work with files and we call it the file system， the files were hierarchical。
 ...
 whether there should be a tree or a network or flat file and we are still debating whether the data have a self-deib tag and later on we known it as a metadata and now people call it a schema。

So the database system study group come up with a reference model or specification for a minimal functionality of a database management system in order to be a database management system。

 you want to be able to store data， retrieve data， modify data， organize data， delete。

 manipulate data， and it becomes a spec。And during that time， there was a birth of a。

We initiated a birth of an NC。Group， it's now called Insight。
...
You realize that you can have a lot of light bulb， for example， you can have red， light bulb。
 ...
 a communication interface or a area where both of both of us have to understand a common vocabulary or whatever。
...
Testing part is also a very important aspect of when you adopt the standard。
 ...
 you want to certify that the product conform to such a such version of ISO standard， JTC1。
...
And that's what the marketplace wanted to go， the user， of course， Oracle。

Or Microsoft buy my buy my product。Orle is say， buy my product。 And in the procurement， you say。
...
Timing is everything you cant standardize a thing too early or you drive a lot of innovative concepts away because people say。
...
You miss the opportunity， you get too many variety of things coming up and the choice is too much。
 ...
 but of course， SQL is one of the success stories that lift。We have。🎼あ。
