# IBM网络安全分析师专业证书课程6：《网络威胁情报课程》｜P61：22_04_应用安全标准与法规
...
*   **PASTA**：PASTA代表攻击模拟与威胁分析过程，是一种七步式、以风险为中心的方法论。它提供了一个七步流程，用于协调业务目标与技术需求，同时考虑合规性问题和业务分析。该方法旨在提供一个动态的威胁识别、列举和评分过程。威胁模型完成后，安全领域专家会对已识别的威胁进行详细分析，最终列举出适当的安全控制措施。该方法论旨在提供应用程序和基础设施的攻击者中心视图，防御者可据此制定资产中心的缓解策略。
