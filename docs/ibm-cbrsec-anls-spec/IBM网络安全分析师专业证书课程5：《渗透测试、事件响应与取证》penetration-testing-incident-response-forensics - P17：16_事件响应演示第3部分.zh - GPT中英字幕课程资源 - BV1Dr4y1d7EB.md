# IBM网络安全分析师专业证书课程5：《渗透测试、事件响应与取证》penetration-testing-incident-response-forensics - P17：16_事件响应演示第3部分.zh - GPT中英字幕课程资源 - BV1Dr4y1d7EB
...
If the DNS would have been blocked by your DNS server。
 ...
 I didn't tell anyone that I was going through the incident response。😔。



![](img/2c6a6e2b04c13db7634101fdaccc6ea0_31.png)

And then in the second one， which was four。The US attack。There was a lot of events there。 I didn't。
...
Might have wanted to look a little further into。With the after action review， it's for you to learn。
 ...
 it's important to do because it can improve your response time。



![](img/2c6a6e2b04c13db7634101fdaccc6ea0_35.png)

Drastically， just walk through the incident response process one more time。
