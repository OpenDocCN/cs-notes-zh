# IBM网络安全分析师专业证书课程2：《网络安全角色、流程与操作系统安全》roles-processes-operating-system-security - P37：36_云的好处、安全性和治理.zh - GPT中英字幕课程资源 - BV1G44y1F7oo
...
Now let's talk about cloud governance and this is going to finish the cloud security portion of the slides in order to have a an effective cloud strategy。
 ...
 which is the little circles you see on your right side。And as you see there。The three of them。

 the governance， the service and the organization need to overlap in different places right you cannot have governance if it's not aligned to your service or the service you're providing in the cloud。
