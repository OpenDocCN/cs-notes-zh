# Java全栈开发 专项课程（上）：01：课程介绍与JavaScript入门
...
1.  **代码编辑器**：用于编写和编辑JavaScript代码的工具，例如Visual Studio Code、Sublime Text或Atom。
2.  **网页浏览器**：用于运行和测试JavaScript程序的工具，例如Google Chrome、Mozilla Firefox或Microsoft Edge。
...
*   **基本语法**：JavaScript代码由一系列语句构成，每条语句通常以分号 `;` 结束。
*   **常见数据类型**：
    *   **数字**：用于表示数值，例如 `let age = 25;`
    *   **字符串**：用于表示文本，需要用引号包裹，例如 `let name = "Alice";`
    *   **布尔值**：用于表示真或假，即 `true` 或 `false`
